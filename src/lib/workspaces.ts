...
const hr: Workspace = {
  ...
  sidebar: [
    {
      label: "Dashboard",
      items: [{ title: "HR Dashboard", url: "/hr", icon: LayoutDashboard }],
    },
    {
      label: "People",
      items: [
        ...
        { title: "Training", url: "/hr/training", icon: BookOpen },
      ],
    },
    {
      ...
      items: [
        ...
        { title: "Verification Queue", url: "/hr/attendance/verification", icon: ShieldCheck },
        { title: "Geofence Monitoring", url: "/hr/attendance/geofence", icon: Map },
        { title: "Attendance Issues", url: "/hr/attendance/issues", icon: ShieldAlert },
        { title: "Leave Management", url: "/hr/leave", icon: CalendarDays },
        { title: "Shift Scheduling", url: "/hr/schedule", icon: CalendarRange },
      ],
    },
    {
      label: "Payroll & Benefits",
      items: [
        { title: "Payroll Processing", url: "/hr/payroll", icon: Wallet },
        { title: "Payroll History", url: "/hr/payroll/history", icon: Receipt },
        { title: "Payroll Approvals", url: "/hr/payroll/approvals", icon: CheckSquare },
        { title: "Benefits", url: "/hr/benefits", icon: PieChart },
        { title: "Deductions", url: "/hr/deductions", icon: Wallet },
      ],
    },
    {
      label: "Recruitment",
      items: [
        { title: "Job Postings", url: "/hr/recruitment", icon: ClipboardList },
        { title: "Interviews", url: "/hr/recruitment/interviews", icon: CalendarCheck },
      ],
    },
    {
      label: "Workforce",
      items: [
        { title: "Allocation & Capacity", url: "/hr/workforce", icon: Activity },
      ],
    },
    {
      label: "Analytics",
    ...
    },
    {
      ...
      items: [
        { title: "AI Insights", url: "/hr/ai", icon: Sparkles },
      ],
    },
    {
      label: "Inbox",
      items: [
        ...
        { title: "Settings", url: "/hr/settings", icon: ShieldCheck },
      ],
    },
  ],
};
